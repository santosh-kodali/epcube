...
def generate_sensors(data, enable_total=False, enable_annual=False, enable_monthly=False):
    ...
    specific_names = {
        "batterysoc": "Stato Carica Batteria",
        "batterycurrentelectricity": "Batteria Energia",
        "gridpower": "Rete Potenza",
        "gridelectricity": "Rete Energia",
        "solarelectricity": "Solare Energia",
        "solardcelectricity": "Solare DC Energia",
        "solaracelectricity": "Solare AC Energia",
        "solarpower": "Solare Potenza",
        "solardcpower": "Solare DC Potenza",
        "solaracpower": "Solare AC Potenza",
        "backuppower": "Backup Potenza",
        "backupelectricity": "Consumo di Casa Energia",
        "backupflowpower": "Consumo di Casa Potenza",
        "devid": "EP CUBE ID",
        "selfhelprate": "Rapporto contributo EP CUBE",
        "treenum": "Alberi Salvati",
        "coal": "Carbone Risparmiato",
        "activationdata": "Data Attivazione",
